	...
	<link rel="stylesheet" href="<?= $_cdn_host?>/resource/css/narrow.css?v=<?=$sysData['version']?>" type="text/css" />
	<link rel="stylesheet" href="<?= $_cdn_host?>/resource/js/artDialog/skins/twitter.css" type="text/css" />
	<link rel="stylesheet" href="<?= $_cdn_host?>/resource/css/simplePagination.css?v=<?=$sysData['version']?>" type="text/css" />
