...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
  ...
  <div class="input-group" >
    ...
    <div class="input-group" style="margin-top:8px">
      ...
      <input type="number" id="discount" class="form-control" placeholder="免费券输入0，95折输入95" />
    </div>
    <div class="input-group" style="margin-top:8px">
      <span class="input-group-addon">关联菜品</span>
      <input type="number" id="dish_id" class="form-control" placeholder="输入关联菜品id" />
    </div>
    <div class="input-group" style="margin-top:8px">
      <span class="input-group-addon">过期天数</span>
      <input type="number" id="expire_day" class="form-control" placeholder="领券后几天内可以使用" />
    </div>
